<article class="post">
	<div class="post__left article">
		<div class="article__header">
			<h1 class="article__headline -f-headline">Horror Honcho Behind The Purge and Get Out Is Hacking the Streaming Upheaval</h1>
			<p class="article__author -f-author">Emily Lin</p>
		</div>
