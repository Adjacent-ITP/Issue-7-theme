		...
		<?php else: ?>
			<div class="gallery__wrapper -is-iframes" id="galleryWrapper">
				<div class="gallery__wrapper-video -is-active">
					<div><iframe src="https://player.vimeo.com/video/423278597?autoplay=1&loop=1" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe></div>
				</div>
				<div class="gallery__wrapper-video">
					<div><iframe src="https://player.vimeo.com/video/423281620?autoplay=1&loop=1" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe></div>
				</div>
				<div class="gallery__wrapper-video">
					<div><iframe src="https://player.vimeo.com/video/423283602?autoplay=1&loop=1" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe></div>
				</div>
			</div>
		<?php endif; ?>
	</div>
